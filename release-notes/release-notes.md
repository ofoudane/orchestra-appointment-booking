...
<h2>Custom release - Italy (GP-2829)</h2>
...
| **Id** | **Release notes**
| --- | --- |
| **GP-2829** | **ASL TO4 Italy – Add Booking Id in printed appointment information** 

<h3> Change log </h3>

- Added a new field `label.print.appointment.id` to language file "appointmentBookingMessages.properties".

- Display the booking id in the appointment confirmation page.
